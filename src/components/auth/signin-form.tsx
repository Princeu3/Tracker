  ...
  return (
    <Card className="shadow-lg border-0 animate-scale-in">
      <CardHeader className="text-center">
        ...
        />
        <CardTitle className="text-2xl">Sign in to Tracker</CardTitle>
        <CardDescription>
          Track anything with AI-powered schemas
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <form action={signInWithGoogle}>
          <Button variant="outline" className="w-full active:scale-[0.98]" type="submit">
